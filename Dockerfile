...
RUN apt update
RUN apt -y upgrade
RUN apt -y install curl wget dialog apt-utils libx11-6 libusb-1.0-0 libexpat1 libglu1-mesa libglib2.0-0 libfreetype6 python3 python3-dev libcec4 gnupg gnupg2
